  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-gradient-to-br from-[#106EBE] to-[#0E4A8A]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-4xl px-4">
        <Link href="/quiz/easy" className="card transform transition-transform hover:scale-105">
        ...
        <Link href="/quiz/medium" className="card transform transition-transform hover:scale-105">
        ...
        <Link href="/quiz/hard" className="card transform transition-transform hover:scale-105">
